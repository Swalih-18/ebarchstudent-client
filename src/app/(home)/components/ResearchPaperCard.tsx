  ...
  return (
    <Link href={`/researchpaper/${researchpaper._id}`}>
      <div className="group relative flex flex-col items-center">
        <div
          className="absolute inset-0 rounded-md border border-gray-700/50 bg-gradient-to-b from-gray-900/50 to-black/50 backdrop-blur-sm
        ...
        <div className="relative flex flex-col items-center gap-2 p-4">
          <div className="relative">
            <div
              className="absolute -left-1 top-1 h-full w-full rounded-md bg-gradient-to-r from-primary-500/10 to-white/5 blur-lg
              transition-all duration-300 group-hover:blur-xl group-hover:from-primary-500/20 group-hover:to-white/10"
            />

            <div
              className="absolute -left-1 top-1 h-full w-full rounded-md bg-white/10 blur-sm
          ...
          <div className="mt-2 text-center w-full">
            <h2
              className="line-clamp-1 text-sm font-semibold text-white/90 text-balance
